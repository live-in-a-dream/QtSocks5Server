...
QT_MOC_LITERAL(4, 61, 26), // "udpRemtoSocks5Disconnected"
QT_MOC_LITERAL(5, 88, 14), // "udpSocketError"
QT_MOC_LITERAL(6, 103, 28) // "QAbstractSocket::SocketError"

    },
    "Socks5UDPConnection\0udpSocks5ReadyRead\0"
    "\0remtoSocketReadyRead\0udpRemtoSocks5Disconnected\0"
    "udpSocketError\0QAbstractSocket::SocketError"
};
...
void Socks5UDPConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Socks5UDPConnection *_t = static_cast<Socks5UDPConnection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->udpSocks5ReadyRead(); break;
        case 1: _t->remtoSocketReadyRead(); break;
        case 2: _t->udpRemtoSocks5Disconnected(); break;
        case 3: _t->udpSocketError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject Socks5UDPConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Socks5UDPConnection.data,
      qt_meta_data_Socks5UDPConnection,  qt_static_metacall, nullptr, nullptr}
};
...
void *Socks5UDPConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Socks5UDPConnection.stringdata0))
        return static_cast<void*>(const_cast< Socks5UDPConnection*>(this));
