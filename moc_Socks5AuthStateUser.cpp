...
void Socks5AuthStateUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Socks5AuthStateUser *_t = static_cast<Socks5AuthStateUser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Socks5AuthStateUser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Socks5AuthStateUser.data,
      qt_meta_data_Socks5AuthStateUser,  qt_static_metacall, nullptr, nullptr}
};
...
void *Socks5AuthStateUser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Socks5AuthStateUser.stringdata0))
        return static_cast<void*>(const_cast< Socks5AuthStateUser*>(this));
